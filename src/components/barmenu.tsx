...
import {  AccountIcon, SalesIcon, MarketingIcon, HumansIcon, SettingIcon, AcademyIcon } from "../assets/index";
import { Logo } from "../assets/index"
const Barmenu = () => {
  return (
<div className="bg-[#23262F] text-white w-[5rem] h-[46rem] flex flex-col items-center py-4 space-y-3">
